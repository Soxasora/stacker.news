...
/**
 * SN Button component — always a real <button>; link-shaped buttons are
 * plain Links styled with buttonClasses() (§4c; the href/as shim died at
 * C9a with its last consumer)
 * @param {string} variant - The variant of the button
 * @param {string} size - The size of the button
