...
export const PAY_IN_ACT_TYPES = ['ZAP', 'DOWN_ZAP', 'BOOST']
...
export const DEFAULT_COMMENTS_SATS_FILTER = 1
// Higher filter threshold for homepage (null sub) lit/top feeds
export const HOMEPAGE_POSTS_SATS_FILTER = 200
...
export const SN_ADMIN_IDS = [USER_ID.k00b, USER_ID.sox, USER_ID.scoresby, USER_ID.sn]
...
export const SUB_SORTS = ['stacked', 'spent', 'revenue', 'items']
...
export const ANON_FEE_MULTIPLIER = 10
...
export const DOMAIN_BETA_IDS = [USER_ID.k00b, USER_ID.sox, USER_ID.scoresby, USER_ID.sn]
...
export const ZAP_DEBOUNCE_MS = 1_000
