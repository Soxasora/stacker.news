...
export function buildBrandingCss (theme) {
  ...
  // brandColor is used for brand SVG fill; falls back to primary color if missing
  const brandHex = normalizeHexColor(theme.brandColor) || primaryHex
  if (brandHex) {
    overrides.push(`--theme-brandColor: ${brandHex};`)
  }
